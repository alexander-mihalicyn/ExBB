...
echo <<<DATA
				...
				<tr>
					...
					<td align="right">
						<div id="navstrip" align="right">
							<a href="tools.php?action=threadstop" title="{$fm->LANG['TopicsRaiting']}">{$fm->LANG['TopicsRaiting']}</a>
						</div>
			...
			<table cellpadding="4" cellspacing="1" border="0" width="100%" class="tableborder">
				...
				<tr>
					<td width="5%" class="row2" align="center" rowspan="{$rowspan}"><img src="./templates/InvisionExBB/im/user.gif" border="0" alt="Active Users" /></td>
...
if ($fm->exbb['rss'] === TRUE) {
echo <<<DATA
		<a href="tools.php?action=rss" target="_blank" title="RSS êàíàë ôîðóìà {$GLOBALS['fm']->exbb['boardname']}"><img src="./im/images/rss20.gif" width="80" height="15" alt="RSS" border="0"></a>
DATA;
}
echo <<<DATA
	</div>
