...
echo <<<DATA
			...
			<form action="postings.php" method="post" name="postform">
				...
				<table class="tableborder" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td class="maintitle" colspan="2"><img src="./templates/InvisionExBB/im/nav_m.gif" border="0" alt="&gt;" width="8" height="8" />&nbsp;{$fm->LANG['EditTopic']}</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="pformleft"><input type="text" name="description" size="45" maxlength="160" style="width:450px" value="{$description}" /></td>
					</tr>
					<tr>
                        <td class="pformleft"><b>{$fm->LANG['TopicKeywords']}</b></td>
                        <td class="pformright"><input type="text" name="keywords" size="45" maxlength="255" style="width: 450px" value="{$keywords}" /></td>
                    </tr>
					<tr>
