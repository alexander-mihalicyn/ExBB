...
<table class="tableborder" width="100%" border="0" cellspacing="1" cellpadding="4">
	<tr>
		<th colspan="5" class="maintitle" align="left"><img src="./templates/InvisionExBB/im/nav_m.gif" border="0"
															alt="&gt;" width="8" height="8"/>&nbsp;{$sublist}</a></th>
	</tr>
	<tr>
...
<div id="navstrip" align="left">
	<img src="./templates/InvisionExBB/im/nav.gif" border="0" alt="&gt;"/>&nbsp;<a
			href="index.php">{$fm->exbb['boardname']}</a>&nbsp;&raquo;&nbsp;{$navi}&nbsp;&raquo;&nbsp;<a
			href="forums.php?forum={$forum_id}">{$forumname}</a>&nbsp;&nbsp;<font
			style="font-size: 10px; color: #ff0000;"><b>{$fm->_Modoutput}</b></font>
</div>
{$sub}
...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class="tableborder">
	<tr>
		<td class="maintitle" colspan="6"><img src="./templates/InvisionExBB/im/nav_m.gif" border="0" alt="&gt;"
											   width="8" height="8"/>&nbsp;{$forumname}</td>
	</tr>
	<tr>
		<th align="center" class="titlemedium"><img src="./templates/InvisionExBB/im/spacer.gif" width="20" height="1"/>
		</th>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
	<tr>
		<td><img src="./templates/InvisionExBB/im/new.gif" border="0"
				 align="absmiddle"/>&nbsp;&nbsp;{$fm->LANG['TopicOpenNew']}</td>
		<td><img src="./templates/InvisionExBB/im/stickynew.gif" border="0"
				 align="absmiddle"/>&nbsp;&nbsp;{$fm->LANG['TopicPinnedNew']}</td>
		<td><img src="./templates/InvisionExBB/im/hotnew.gif" border="0"
				 align="absmiddle"/>&nbsp;&nbsp;{$fm->LANG['TopicHotNew']}</td>
		<td><img src="./templates/InvisionExBB/im/locked.gif" border="0"
				 align="absmiddle"/>&nbsp;&nbsp;{$fm->LANG['TopicClosed']}</td>
	</tr>
	<tr>
		<td><img src="./templates/InvisionExBB/im/nonew.gif" border="0"
				 align="absmiddle"/>&nbsp;&nbsp;{$fm->LANG['TopicOpenNoNew']}</td>
		<td><img src="./templates/InvisionExBB/im/sticky.gif" border="0"
				 align="absmiddle"/>&nbsp;&nbsp;{$fm->LANG['TopicPinnedNoNew']}</td>
		<td><img src="./templates/InvisionExBB/im/hotnonew.gif" border="0"
				 align="absmiddle"/>&nbsp;&nbsp;{$fm->LANG['TopicHotNoNew']}</td>
		<td><img src="./templates/InvisionExBB/im/moved.gif" border="0"
				 align="absmiddle"/>&nbsp;&nbsp;{$fm->LANG['TopicMoved']}</td>
	</tr>
</table>
DATA;
?>
