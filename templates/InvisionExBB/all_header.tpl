...
<html>
<head>
	<title><?php echo $GLOBALS['fm']->exbb['boardname']; ?><?php echo $GLOBALS['fm']->_Title; ?></title>
	<meta http-equiv="Content-Type" content="text/html; charset=<?php echo $GLOBALS['fm']->LANG['ENCODING']; ?>">
	<meta http-equiv="Content-Language" content="ru">
	<meta http-equiv="Cache-Control" content="private">
	<meta name="description" content="ExBB Full Mods <?php echo $GLOBALS['fm']->exbb['version']; ?> Форум на PHP">
	...
	<link rel="alternate" type="application/rss+xml" title="<?php echo $GLOBALS['fm']->exbb['boardname']; ?>"
		  href="./tools.php?action=rss">
...
<body<?php echo $GLOBALS['fm']->_Body; ?>>
<a name="top"></a>
