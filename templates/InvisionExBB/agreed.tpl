	...
	<table cellpadding="6" cellspacing="1" border="0" width="100%" align="center" class="tableborder">
		<tr>
			<td class="maintitle" colspan="2" align="center" height="29"><span
						class="medium"><b>{$fm->LANG['RegInfo']}</b></span></td>
		</tr>
		<tr>
		...
		<DATA
		<tr>
			<td class="profilleft"><b>{$fm->LANG['YouEmail']}</b><br/><span
						class="desc">{$fm->LANG['YouEmailDesc']}</span></td>
			<td class="profilright">
		...
		<DATA
		<tr>
			<td class="profilleft"><b>{$fm->LANG['CaptchaCode']}</b><br/><span
						class="desc">{$fm->LANG['CaptchaBroken']}</span></td>
			<td class="profilright"><img src="regimage.php" id="captcha" border="0" alt="captcha"></td>
		</tr>
		<tr>
			<td class="profilleft"><b>{$fm->LANG['CaptchaСonfirm']}</b><br/><span
						class="desc">{$fm->LANG['CaptchaNote']}</span></td>
		...
		<DATA
		<tr>
			<td class="titlemedium" colspan="2" align="center">{$fm->LANG['AboutSelf']} ({$fm->LANG['NotNeededInfo']})
			</td>
		</tr>
		{$select_birstday}
		<tr>
		...
		<tr>
			<td class="profilleft"><b>{$fm->LANG['Interests']}</b><br/><span class="desc">{$fm->LANG['InterestsDesc']}
			</td>
			<td class="profilright"><input type="text" style="width: 200px" name="interests" size="25" maxlength="100">
			</td>
		</tr>
		<tr>
			<td class="profilleft"><b>{$fm->LANG['Signature']}</b><br/><span
						class="desc">{$fm->LANG['SignatureDesc']}</span></td>
		...
		<tr>
			...
			<td class="profilright"><input name="sig_on" type="radio" value="yes"> {$fm->LANG['Yes']} &nbsp; <input
						name="sig_on" type="radio" value="no" checked> {$fm->LANG['No']}</td>
		</tr>
		<tr>
		...
		<DATA
		<tr>
			<td class="profilleft"><b>{$fm->LANG['ShowEmail']}</b><br/><span
						class="desc">{$fm->LANG['ShowEmailDesc']}</span></td>
			<td class="profilright"><input name="showemail" type="radio" value="yes"> {$fm->LANG['Yes']} &nbsp; <input
						name="showemail" type="radio" value="no" checked> {$fm->LANG['No']}</td>
		</tr>
		DATA;
		}
		...
		<tr><!-- /* Уведомления по E-mail о новых ЛС */ -->
			<td class="profilleft" valign="top"><b>{$fm->LANG['NewPMNotify']}</b><br/><span
						class="desc">{$fm->LANG['NewPMNotifyDesc']}</span></td>
			<td class="profilright"><input class="tab" type="radio" name="pm_newmes" value="yes"/> {$fm->LANG['Yes']}
				&nbsp; <input class="tab" type="radio" name="pm_newmes" value="no" checked/> {$fm->LANG['No']}</td>
		</tr>
		...
		<tr><!-- /* Скрытый режим пребывания на форуме */ -->
			<td class="profilleft" valign="top"><b>{$fm->LANG['VisibleMode']}</b><br/><span
						class="desc">{$fm->LANG['VisibleModeDesc']}</span></td>
			<td class="profilright"><input class="tab" type="radio" name="visiblemode" value="yes"/> {$fm->LANG['Yes']}
				&nbsp; <input class="tab" type="radio" name="visiblemode" value="no" checked/> {$fm->LANG['No']}</td>
		</tr>
		...
		<tr>
			<td class="profilleft"><b>{$fm->LANG['TimeZone']}</b><br/>{$fm->LANG['CurrTime']} {$basetimes}<br/><span
						class="desc">{$fm->LANG['YouZone']}</span></td>
			<td class="profilright">
		...
		<tr>
			<td valign="top" class="profilleft"><b>{$fm->LANG['Avatar']}</b><br/><span
						class="desc">{$fm->LANG['YourAvatar']}</span></td>
			<td class="profilright">
